...
! column and the flux from a point source in the third. these two data files will then be used to 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 double precision :: User_Values_Flux
 	!Output variable
...
100	print *, ' '
	...
	print *, ' '
	print *, 'with the values you entered, the total flux =  ', User_Values_Flux	
	print *, ' '
...
! containing the value of x0 in the first column, the flux from the reactor in the second 
! column and the flux from a point source in the third.  This data will be used to 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
 ...
 integer :: N
 double precision :: x0, y0, H, W, D, reactor, ptSourceFlux
 ...
 ! to illustrate the relationship between the flux measured from the reactor 
 ! and the flux measured from a point source as x0 gets larger
   ...
   Do j = 1, 100, 2 ! varying distance from reactor to detector, x0  	 
  	 ...
  	 write(9,*)x0, reactor, ptSourceFlux
  	 	!write x0 vs. flux of reactor and flux of pt source to 'fort.9'

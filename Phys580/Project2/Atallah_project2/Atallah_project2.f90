...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
 ...
 Do i = 1, Np
 	rand = RAN3(seed) !store random number generated by RAN3
 	
 	if (rand > 1.0) then
 		rand = rand - 0.1
 	end if 
 	
 	x = rand * D ! Set x to random number between 0 and D
 	y = rand * W ! Set y to random number between 0 and W
 	z = rand * H ! Set z to random number between 0 and H

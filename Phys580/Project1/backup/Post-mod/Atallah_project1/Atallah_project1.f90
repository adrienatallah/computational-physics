...
double precision :: x, dx 			
	!input variables
double precision :: f, f2p 
	!function declaration 
double precision :: f3, f5 			
	!numerically calculated 2nd derivatives of f(x); f3 is for 3pt formula, f5 is for 5pt;
	!calculated by subroutine 'df(x,dx,fp,f3,f5)'
double precision :: fp			
	!variable to store exact formula for 2nd derivative of f(x); calcluated by function 'f2p(b)' 
!double precision :: fxph, fxmh, fxp2h, fxm2h 		
	!fxph=f(x+h), fxmh=f(x-h), fxp2h=f(x+2h), fxm2h=f(x-2h)
...
double precision :: fx, fxph, fxmh, fxp2h, fxm2h 
	!intermediate values used in calcuating approximations for 2nd derivative of f(x)		
	!fxph=f(x+h), fxmh=f(x-h), fxp2h=f(x+2h), fxm2h=f(x-2h)
integer i 
	!counter for do loop, used to generate data files
